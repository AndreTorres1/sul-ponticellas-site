...
const translations = {
  pt: {
    ...
    "musicians.card3.title": "A completar",
    "musicians.card3.copy": "Espaço reservado para a apresentação da Verónica: percurso, instrumento, estilo e a forma como a sua presença acrescenta cor ao som do quarteto.",
  ...
  es: {
    ...
    "musicians.card3.kicker": "Verónica",
    "musicians.card3.title": "Por completar",
    "musicians.card3.copy": "Espacio reservado para la presentación de Verónica: trayectoria, instrumento, estilo y la forma en que su presencia suma color al sonido del cuarteto.",
    "musicians.card4.kicker": "Jéssica",
